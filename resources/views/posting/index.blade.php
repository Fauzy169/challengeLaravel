    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Draggble Post</h2>
            <p class="mt-2 text-lg/8 text-gray-600">Catat Kegiatan mu disini untuk meliha tsejauh mana kamu melangkah</p>
